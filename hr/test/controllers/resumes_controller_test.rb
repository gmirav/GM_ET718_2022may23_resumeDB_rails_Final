...
class ResumesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create resume" do
    assert_difference('Resume.count') do
      post resumes_url, params: { resume: { avatar: @resume.avatar, email: @resume.email, location: @resume.location, name: @resume.name, phone: @resume.phone, role: @resume.role } }
    end
  ...
  test "should update resume" do
    patch resume_url(@resume), params: { resume: { avatar: @resume.avatar, email: @resume.email, location: @resume.location, name: @resume.name, phone: @resume.phone, role: @resume.role } }
